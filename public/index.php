                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    if ($resultado && mysqli_num_rows($resultado) > 0) {
                        while ($fila = mysqli_fetch_array($resultado)) {
                            ...
                            echo "<form action='agregar_carrito.php' method='POST' class='inline-block' onsubmit=\"return validarCantidad(this.cantidad.value, " . $fila['stock'] . ", " . $fila['stock_minimo'] . ", " . $fila['stock_maximo'] . ")\">";
