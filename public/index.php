                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    if ($resultado && mysqli_num_rows($resultado) > 0) {
                        while ($fila = mysqli_fetch_array($resultado)) {
                            ...
                            echo "<form action='app/controllers/agregar_carrito.php' method='POST' class='inline-block' onsubmit=\"return validarCantidad(this.cantidad.value, " . $fila['stock'] . ", " . $fila['stock_minimo'] . ", " . $fila['stock_maximo'] . ")\">";
                            echo "<input type='number' name='cantidad' value='1' min='1' max='" . $fila['stock'] . "' required class='w-20 border rounded px-2 py-1'>";
                            ...
                            echo "</form>";
                            echo "<a href='app/controllers/comprar.php?codigo_barras=" . $fila['codigo_barras'] . "' class='block mt-2 px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 transition'>Comprar</a>";
                            echo "</td>";
